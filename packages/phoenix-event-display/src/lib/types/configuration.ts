...
export interface Configuration {
  ...
  /** The default magnetic field strength of this event display. Will be used for extrapolating or interpolating*/
  magneticFieldStrength?: number;
  /** The scale parameter of event display**/
  eventScale?: number;
  /** The max number of nodes will be displayed by the software **/
  maxNumNodes?: number;
  /** The max number of faces will be displayed by the software **/
  maxNumFaces?: number;
}
